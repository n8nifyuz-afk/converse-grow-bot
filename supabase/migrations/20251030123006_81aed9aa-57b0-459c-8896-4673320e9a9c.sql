-- Remove login tracking from handle_new_user trigger
-- Login tracking should only happen via log-user-activity edge function
...
BEGIN
  ...
  -- This trigger now ONLY handles profile creation on signup
  -- Login tracking happens in log-user-activity edge function
  ...
  -- Insert or update profile (NO login tracking here)
  ...
  -- Send welcome email only for NEW signups and email-based signups
