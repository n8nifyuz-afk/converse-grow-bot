            ...
            <div className="w-full md:w-5/12 p-3 sm:p-4 md:p-5 flex flex-col bg-gradient-to-br from-white to-zinc-50/50 dark:from-zinc-950 dark:to-zinc-900/30 justify-between">
              ...
              <div className="space-y-1 flex-shrink-0">
                ...
                <div className="flex items-center justify-center gap-1.5 sm:gap-2 py-0.5">
                  ...
                  {/* American Express */}
                  <div className="w-10 h-7 sm:w-12 sm:h-8 flex items-center justify-center">
                    <svg className="w-full h-full" viewBox="0 0 1000 997.52" fill="none">
                      <path d="M0 952.35V602.86l37.39-87.18h64.67l21.22 48.83v-48.83h80.39l12.63 35.29 12.25-35.29h360.86v17.74s18.97-17.74 50.15-17.74h117.08l20.85 48.19v-48.6h67.27l18.52 27.68v-27.68h67.89v156.61h-67.89l-17.74-27.77v27.77h-98.84l-9.94-24.69h-26.57l-9.78 24.69h-67.03c-26.83 0-43.97-17.38-43.97-17.38v17.38H500.94l-20.06-24.69v24.69H105.08l-9.93-24.69h-26.49l-9.86 24.69H0z" fill="#016fd0"/>
                      <path d="M0 952.35V602.86l37.39-87.18h64.67l21.22 48.83v-48.83h80.39l12.63 35.29 12.25-35.29h360.86v17.74s18.97-17.74 50.15-17.74h117.08l20.85 48.19v-48.6h67.27l18.52 27.68v-27.68h67.89v156.61h-67.89l-17.74-27.77v27.77h-98.84l-9.94-24.69h-26.57l-9.78 24.69h-67.03c-26.83 0-43.97-17.38-43.97-17.38v17.38H500.94l-20.06-24.69v24.69H105.08l-9.93-24.69h-26.49l-9.86 24.69H0zM249.14 1697.44v-156.61h165.82l17.79 23.19 18.38-23.19h601.89v145.81s-15.74 10.64-33.94 10.8h-333.28l-20.06-24.69v24.69h-65.73v-42.14s-8.98 5.88-28.39 5.88h-22.37v36.26h-99.52l-17.77-23.69-18.04 23.69h-164.88z" fill="#016fd0"/>
                      <path d="M50.56 864.93l-50.44 117.26h32.84l9.31-23.48h54.1l9.26 23.48h33.56l-50.39-117.26H50.56zm18.66 27.29l16.49 41.03h-33.03l16.54-41.03zM191.85 982.17v-117.26h46.66l27.14 75.6 26.49-75.78h46.29v117.26h-29.32v-86.41l-31.08 86.41h-25.71l-31.16-86.41v86.41h-29.31zM358.49 982.17v-117.26h95.66v26.23h-66.04v20.06h64.5v24.69h-64.5v20.83h66.04v25.45h-95.66zM471.13 864.93v117.26h29.32v-41.66h12.34l35.15 41.66h35.83l-38.57-43.2c15.83-1.34 32.16-14.92 32.16-36.02 0-24.68-19.37-38.04-40.98-38.04h-65.24zm29.32 26.23h33.51c8.04 0 13.89 6.29 13.89 12.34 0 7.79-7.58 12.34-13.45 12.34h-33.95v-24.69zM619.25 982.17h-29.93v-117.26h29.93v117.26zM690.23 982.17l-6.46-.01c-31.26 0-50.24-24.63-50.24-58.15 0-34.35 18.77-59.11 58.25-59.11h32.4v27.77h-33.59c-16.03 0-27.36 12.51-27.36 31.63 0 22.71 12.96 32.25 31.63 32.25h7.71l-.34 25.62zM754.02 864.93l-50.44 117.26h32.84l9.31-23.48h54.1l9.26 23.48h33.56l-50.39-117.26h-38.24zm18.66 27.29l16.49 41.03h-33.03l16.54-41.03zM846.07 982.17v-117.26h37.27l47.59 73.68v-73.68h29.32v117.26h-36.07l-48.8-75.6v75.6h-29.31z" fill="#fff"/>
                      <path d="M193.74 1187.39v-117.26h95.66v26.23h-66.04v20.06h64.5v24.69h-64.5v20.83h66.04v25.45h-95.66zM662.37 1187.39v-117.26h95.66v26.23h-66.04v20.06h64.19v24.69h-64.19v20.83h66.04v25.45h-95.66zM293.11 1187.39l46.58-57.91-47.69-59.35h36.93l28.4 36.69 28.5-36.69h35.49l-47.06 58.63 46.66 58.63h-36.93l-27.58-36.11-26.91 36.11h-36.39zM424.41 1070.14v117.26h30.09v-37.03h30.86c26.11 0 45.9-13.85 45.9-40.79 0-22.32-15.52-39.44-42.09-39.44h-64.76zm30.09 26.52h32.5c8.44 0 14.47 5.17 14.47 13.5 0 7.83-6 13.5-14.56 13.5h-32.4v-27zM543.99 1070.12v117.26h29.32v-41.66h12.34l35.15 41.66h35.83l-38.57-43.2c15.83-1.34 32.16-14.92 32.16-36.02 0-24.68-19.37-38.04-40.98-38.04h-65.24zm29.32 26.23h33.51c8.04 0 13.89 6.29 13.89 12.34 0 7.79-7.58 12.34-13.45 12.34h-33.95v-24.69zM771.73 1187.39v-25.46h58.67c8.68 0 12.44-4.69 12.44-9.84 0-4.93-3.75-9.91-12.44-9.91h-26.51c-23.05 0-35.88-14.04-35.88-35.12 0-18.8 11.75-36.93 46-36.93h57.09l-12.34 26.38h-49.37c-9.44 0-12.34 4.95-12.34 9.68 0 4.86 3.59 10.22 10.8 10.22h27.77c25.69 0 36.84 14.57 36.84 33.66 0 20.52-12.42 37.32-38.24 37.32h-62.49zM879.33 1187.39v-25.46h58.67c8.68 0 12.44-4.69 12.44-9.84 0-4.93-3.75-9.91-12.44-9.91h-26.51c-23.05 0-35.88-14.04-35.88-35.12 0-18.8 11.75-36.93 46-36.93h57.09l-12.34 26.38h-49.37c-9.44 0-12.34 4.95-12.34 9.68 0 4.86 3.59 10.22 10.8 10.22h27.77c25.69 0 36.84 14.57 36.84 33.66 0 20.52-12.42 37.32-38.24 37.32h-62.49z" fill="#fff"/>
                    </svg>
                  </div>
                </div>
