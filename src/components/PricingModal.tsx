                ...
                <div className="flex items-center justify-center gap-3 sm:gap-4 py-1 sm:py-2">
                  ...
                  <div className="w-14 h-10 sm:w-16 sm:h-12 flex items-center justify-center">
                    <svg className="w-full h-full" viewBox="0 0 750 471" fill="none">
                      ...
                      <path d="M661.6145,138.4655 L620.3835,138.4655 C607.6105,138.4655 598.0525,141.9515 592.4425,154.6995 L513.1975,334.1025 L569.2285,334.1025 C569.2285,334.1025 578.3905,309.9805 580.4625,304.6845 C586.5855,304.6845 641.0165,304.7685 648.7985,304.7685 C650.3945,311.6215 655.2905,334.1025 655.2905,334.1025 L704.8025,334.1025 L661.6145,138.4655 Z M596.1975,264.8725 C600.6105,253.5935 617.4565,210.1495 617.4565,210.1495 C617.1415,210.6705 621.8365,198.8155 624.5315,191.4655 L628.1385,208.3435 C628.1385,208.3435 638.3555,255.0725 640.4905,264.8715 L596.1975,264.8715 L596.1975,264.8725 Z" fill="#F7A600" />
                      <path d="M 45.878906 138.46484 L 45.197266 142.53906 C 66.288263 147.64458 85.126465 155.03257 101.61914 164.22461 L 148.96484 333.91602 L 205.41992 333.84961 L 289.42383 138.46484 L 232.90234 138.46484 L 180.66211 271.96094 L 175.0957 244.83203 C 174.83824 244.00408 174.55942 243.17304 174.27344 242.3418 L 156.10742 154.99219 C 152.87742 142.59619 143.50892 138.89684 131.91992 138.46484 L 45.878906 138.46484 z " fill="#1434CB" />
                    </svg>
                  </div>
                  {/* Mastercard */}
                  <div className="w-14 h-10 sm:w-16 sm:h-12 flex items-center justify-center">
                    <svg className="w-full h-full" viewBox="0 0 70 48" fill="none">
                  ...
                  {/* Apple Pay */}
                  <div className="w-14 h-10 sm:w-16 sm:h-12 flex items-center justify-center">
                    <svg className="w-full h-full" viewBox="0 0 58 40" fill="none">
