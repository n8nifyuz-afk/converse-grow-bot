...
export const PricingModal: React.FC<PricingModalProps> = ({ open, onOpenChange }) => {
  ...
  const modalContent = (
    <div className="flex flex-col md:flex-row h-full">
            ...
            {/* Right Panel - Pricing */}
            <div className="w-full md:w-5/12 p-6 sm:p-5 md:p-5 flex flex-col bg-gradient-to-br from-white to-zinc-50/50 dark:from-zinc-950 dark:to-zinc-900/30 md:justify-between">
              ...
              <div className="flex-1 md:flex-none min-h-[2rem]"></div>
              
              {/* Footer */}
              <div className="space-y-2 sm:space-y-1.5 flex-shrink-0 mt-auto">
                {/* Pay Safe & Secure */}
