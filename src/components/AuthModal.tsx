...
export default function AuthModal({
  ...
  const authContent = <div className="flex flex-col h-full overflow-y-auto overscroll-contain md:min-h-[420px]">
          {/* Auth Form */}
  ...
  if (isMobile) {
    return <Drawer open={isOpen} onOpenChange={onClose} dismissible={mode !== 'phone' && mode !== 'verify'} modal={false}>
        <DrawerContent className="fixed bottom-0 left-0 right-0 h-auto max-h-[85vh] p-0 border-t-4">
