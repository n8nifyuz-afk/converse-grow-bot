          ...
          <div className="w-full md:w-1/2 bg-gradient-to-br from-background to-muted/30 p-4 sm:p-6 md:p-8 lg:p-10 flex flex-col items-center justify-start border-r border-border overflow-hidden relative">
            ...
            <div className="text-center mb-4 sm:mb-6 md:mb-8 z-10">
              ...
              <div className="flex justify-center px-4">
                <div className="inline-flex gap-3 sm:gap-4 md:gap-5 items-center flex-nowrap">
                  <div className="w-11 h-11 sm:w-13 sm:h-13 flex-shrink-0 rounded-xl bg-gradient-to-br from-blue-500/10 to-blue-600/10 hover:from-blue-500/20 hover:to-blue-600/20 border border-blue-500/20 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/20 flex items-center justify-center group cursor-pointer">
                    <svg className="w-6 h-6 sm:w-7 sm:h-7 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24">
                  ...
                  <div className="w-11 h-11 sm:w-13 sm:h-13 flex-shrink-0 rounded-xl bg-gradient-to-br from-green-500/10 to-green-600/10 hover:from-green-500/20 hover:to-green-600/20 border border-green-500/20 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-green-500/20 flex items-center justify-center group cursor-pointer">
                    <img src="/whatsapp-icon.svg" alt="WhatsApp" className="w-6 h-6 sm:w-7 sm:h-7 object-contain group-hover:scale-110 transition-transform duration-300" />
                  </div>
                  <div className="w-11 h-11 sm:w-13 sm:h-13 flex-shrink-0 rounded-xl bg-gradient-to-br from-yellow-500/10 to-red-500/10 hover:from-yellow-500/20 hover:to-red-500/20 border border-yellow-500/20 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-yellow-500/20 flex items-center justify-center group cursor-pointer">
                    <img src="/chrome-icon.svg" alt="Chrome" className="w-6 h-6 sm:w-7 sm:h-7 object-contain group-hover:scale-110 transition-transform duration-300" />
                  </div>
                  <div className="w-11 h-11 sm:w-13 sm:h-13 flex-shrink-0 rounded-xl bg-gradient-to-br from-orange-500/10 to-purple-600/10 hover:from-orange-500/20 hover:to-purple-600/20 border border-orange-500/20 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-orange-500/20 flex items-center justify-center group cursor-pointer">
                    <img src="/firefox-icon.svg" alt="Firefox" className="w-6 h-6 sm:w-7 sm:h-7 object-contain group-hover:scale-110 transition-transform duration-300" />
                  </div>
                  <div className="w-11 h-11 sm:w-13 sm:h-13 flex-shrink-0 rounded-xl bg-gradient-to-br from-blue-400/10 to-cyan-500/10 hover:from-blue-400/20 hover:to-cyan-500/20 border border-blue-400/20 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-400/20 flex items-center justify-center group cursor-pointer">
                    <img src="/edge-icon-new.svg" alt="Edge" className="w-6 h-6 sm:w-7 sm:h-7 object-contain group-hover:scale-110 transition-transform duration-300" />
                  </div>
                  <div className="w-11 h-11 sm:w-13 sm:h-13 flex-shrink-0 rounded-xl bg-gradient-to-br from-blue-500/10 to-indigo-600/10 hover:from-blue-500/20 hover:to-indigo-600/20 border border-blue-500/20 transition-all duration-300 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/20 flex items-center justify-center group cursor-pointer">
                    <img src="/safari-icon-new-final.svg" alt="Safari" className="w-6 h-6 sm:w-7 sm:h-7 object-contain group-hover:scale-110 transition-transform duration-300" />
                  </div>
                </div>
              </div>
            </div>
