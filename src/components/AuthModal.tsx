              ...
              <div className="flex justify-center px-4">
                <div className="relative inline-flex gap-2.5 sm:gap-3 items-center flex-nowrap p-3 sm:p-3.5 rounded-2xl sm:bg-background/60 sm:backdrop-blur-md sm:border sm:border-border/50 sm:shadow-lg overflow-hidden">
                  ...
                  <div className="absolute inset-0 pointer-events-none opacity-30">
                    ...
                    <div className="absolute bottom-2 right-3 text-[10px] text-accent/20 font-mono">#</div>
                    <div className="absolute top-1/2 left-1/4 w-px h-3 bg-primary/10 rotate-45"></div>
                  </div>
                  
                  <div className="relative w-9 h-9 sm:w-10 sm:h-10 flex-shrink-0 rounded-lg bg-background/80 border border-border/30 transition-all duration-300 hover:scale-110 hover:border-primary/30 hover:shadow-md flex items-center justify-center group cursor-pointer">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 group-hover:scale-110 transition-transform duration-300" viewBox="0 0 24 24">
                  ...
                  <div className="relative w-9 h-9 sm:w-10 sm:h-10 flex-shrink-0 rounded-lg bg-background/80 border border-border/30 transition-all duration-300 hover:scale-110 hover:border-primary/30 hover:shadow-md flex items-center justify-center group cursor-pointer">
                    <img src="/whatsapp-icon.svg" alt="WhatsApp" className="w-5 h-5 sm:w-6 sm:h-6 object-contain group-hover:scale-110 transition-transform duration-300" />
                  </div>
                  <div className="relative w-9 h-9 sm:w-10 sm:h-10 flex-shrink-0 rounded-lg bg-background/80 border border-border/30 transition-all duration-300 hover:scale-110 hover:border-primary/30 hover:shadow-md flex items-center justify-center group cursor-pointer">
                    <img src="/chrome-icon.svg" alt="Chrome" className="w-5 h-5 sm:w-6 sm:h-6 object-contain group-hover:scale-110 transition-transform duration-300" />
                  </div>
                  <div className="relative w-9 h-9 sm:w-10 sm:h-10 flex-shrink-0 rounded-lg bg-background/80 border border-border/30 transition-all duration-300 hover:scale-110 hover:border-primary/30 hover:shadow-md flex items-center justify-center group cursor-pointer">
                    <img src="/firefox-icon.svg" alt="Firefox" className="w-5 h-5 sm:w-6 sm:h-6 object-contain group-hover:scale-110 transition-transform duration-300" />
                  </div>
                  <div className="relative w-9 h-9 sm:w-10 sm:h-10 flex-shrink-0 rounded-lg bg-background/80 border border-border/30 transition-all duration-300 hover:scale-110 hover:border-primary/30 hover:shadow-md flex items-center justify-center group cursor-pointer">
                    <img src="/edge-icon-new.svg" alt="Edge" className="w-5 h-5 sm:w-6 sm:h-6 object-contain group-hover:scale-110 transition-transform duration-300" />
                  </div>
                  <div className="relative w-9 h-9 sm:w-10 sm:h-10 flex-shrink-0 rounded-lg bg-background/80 border border-border/30 transition-all duration-300 hover:scale-110 hover:border-primary/30 hover:shadow-md flex items-center justify-center group cursor-pointer">
                    <img src="/safari-icon-new-final.svg" alt="Safari" className="w-5 h-5 sm:w-6 sm:h-6 object-contain group-hover:scale-110 transition-transform duration-300" />
                  </div>
                </div>
              </div>
            </div>
