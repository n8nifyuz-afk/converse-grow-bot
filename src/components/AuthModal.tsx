          ...
          <div className="w-full md:w-1/2 bg-gradient-to-br from-background to-muted/30 p-4 sm:p-6 md:p-8 lg:p-10 flex flex-col items-center justify-start border-r border-border overflow-hidden relative">
            ...
            <div className="text-center mb-4 sm:mb-6 md:mb-8 z-10">
              ...
              <div className="flex justify-center px-4">
                <div className="inline-flex gap-2 sm:gap-3 md:gap-4 items-center flex-nowrap p-3 sm:p-4 bg-gradient-to-r from-background/80 via-background/90 to-background/80 backdrop-blur-sm rounded-2xl shadow-xl border border-border/50">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 flex-shrink-0 rounded-xl bg-background hover:bg-accent transition-all duration-300 hover:scale-110 hover:shadow-md flex items-center justify-center group cursor-pointer">
