            ...
            <div className="group relative p-8 rounded-lg bg-white dark:bg-card border-2 border-primary hover:border-primary/70 transition-all duration-200 focus-within:ring-2 focus-within:ring-primary focus-within:ring-offset-2 flex flex-col shadow-lg">
              ...
              <div className="space-y-3 mb-8 flex-1">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-foreground text-sm">{t('pricing.proFeatures.gpt')}</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-primary rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Check className="h-3 w-3 text-primary-foreground" aria-hidden="true" />
                  </div>
                  <span className="text-foreground text-sm">{t('pricing.proFeatures.gemini')}</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-muted rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <X className="h-3 w-3 text-muted-foreground" aria-hidden="true" />
                  </div>
                  <span className="text-muted-foreground text-sm">{t('pricing.proFeatures.claude')}</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-primary rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Check className="h-3 w-3 text-primary-foreground" aria-hidden="true" />
                  </div>
                  <span className="text-foreground text-sm">{t('pricing.proFeatures.voiceMode')}</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-primary rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Check className="h-3 w-3 text-primary-foreground" aria-hidden="true" />
                  </div>
                  <span className="text-foreground text-sm">{t('pricing.proFeatures.askPdf')}</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-primary rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Check className="h-3 w-3 text-primary-foreground" aria-hidden="true" />
                ...
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-foreground text-sm">{t('pricing.proFeatures.prioritySupport')}</span>
                </div>
              </div>
            ...
            <div className="group p-8 rounded-lg bg-white dark:bg-card border-2 border-black/10 dark:border-border hover:border-primary/50 transition-all duration-200 focus-within:ring-2 focus-within:ring-primary focus-within:ring-offset-2 flex flex-col shadow-sm">
              ...
              <div className="space-y-3 mb-8 flex-1">
                <div className="flex items-start gap-3">
                  ...
                  <span className="text-foreground text-sm">{t('pricing.ultraFeatures.gpt')}</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-primary rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Check className="h-3 w-3 text-primary-foreground" aria-hidden="true" />
                  </div>
                  <span className="text-foreground text-sm">{t('pricing.ultraFeatures.gemini')}</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-primary rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Check className="h-3 w-3 text-primary-foreground" aria-hidden="true" />
                  </div>
                  <span className="text-foreground text-sm">{t('pricing.ultraFeatures.claude')}</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-primary rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Check className="h-3 w-3 text-primary-foreground" aria-hidden="true" />
                  </div>
                  <span className="text-foreground text-sm">{t('pricing.ultraFeatures.deepseek')}</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-primary rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Check className="h-3 w-3 text-primary-foreground" aria-hidden="true" />
                  </div>
                  <span className="text-foreground text-sm">{t('pricing.ultraFeatures.grok')}</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-primary rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Check className="h-3 w-3 text-primary-foreground" aria-hidden="true" />
                  </div>
                  <span className="text-foreground text-sm">{t('pricing.ultraFeatures.voiceMode')}</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-primary rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Check className="h-3 w-3 text-primary-foreground" aria-hidden="true" />
                  </div>
                  <span className="text-foreground text-sm">{t('pricing.ultraFeatures.askPdf')}</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-primary rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Check className="h-3 w-3 text-primary-foreground" aria-hidden="true" />
                  </div>
                  <span className="text-foreground text-sm">{t('pricing.ultraFeatures.highPrioritySupport')}</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-muted rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <span className="text-xs text-muted-foreground">Soon</span>
                  </div>
                  <span className="text-muted-foreground text-sm">{t('pricing.ultraFeatures.whatsapp')}</span>
                </div>
              </div>
              ...
              ) : subscriptionStatus.plan === 'ultra_pro' ? (
                <div className="w-full py-3 px-4 rounded-lg bg-primary/10 border-2 border-primary text-center">
                  <span className="text-sm font-semibold text-primary">{t('pricing.yourCurrentPlan')}</span>
                </div>
              ) : (
