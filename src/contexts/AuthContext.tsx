  ...
  const checkSubscription = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        if (shouldTrack) {
          // Use database flag for reliable deduplication across all devices/sessions
          if (dbSub && !dbSub.payment_tracked) {
            ...
            console.log('✅ Payment conversion tracked and flagged in database');
            ...
            console.log('⏭️ Skipping payment tracking - already tracked in database (payment_tracked flag set)');
          }
        }
